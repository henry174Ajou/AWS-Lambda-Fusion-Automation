        ...
        o(t[i]); return o; } return r; })()({ 1: [function (require, module, exports) {
                ...
                var reIsNative = RegExp('^' +
                    funcToString.call(hasOwnProperty).replace(reRegExpChar, '\\$&')
                        .replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, '$1.*?') + '$');
                /** Built-in value references. */
                var Symbol = root.Symbol, Uint8Array = root.Uint8Array, propertyIsEnumerable = objectProto.propertyIsEnumerable, splice = arrayProto.splice, spreadableSymbol = Symbol ? Symbol.isConcatSpreadable : undefined;
                /* Built-in method references for those with the same name as other `lodash` methods. */
                ...
                module.exports = _mapFactory2.default;
                module.exports.getValue = _objectMapper.getValue;
                module.exports.setValue = _objectMapper.setValue;
            }, { "./map-factory": 9, "./object-mapper/object-mapper": 13 }], 9: [function (require, module, exports) {
                "use strict";
            ...
            }, { "./mapper": 10, "./object-mapper/object-mapper": 13 }], 10: [function (require, module, exports) {
                "use strict";
                Object.defineProperty(exports, "__esModule", {
                    value: true
                });
                ...
                var Mapper = function () {
                    ...
                    _createClass(Mapper, [{
                            ...
                            value: function getTransformDescriptor_(item) {
                                ...
                                var transform = item.transform, alwaysSet = item.alwaysSet, alwaysTransform = item.alwaysTransform, pipelineTransformations = item.pipelineTransformations, flatten = item.flatten, flattenInverted = item.flattenInverted, failureTransform = item.failureTransform;
                            ...
                            value: function processSingleItem_(sourceObject, destinationObject, _ref) {
                                var targetPath = _ref.targetPath, sourcePath = _ref.sourcePath, transform = _ref.transform, failureTransform = _ref.failureTransform, flattenings = _ref.flattenings, options = _ref.options;
                                // Get source
                                var value = void 0;
                                if (!sourcePath) {
                            ...
                            value: function processMultiItem_(sourceObject, destinationObject, _ref2) {
                                var sourcePath = _ref2.sourcePath, targetPath = _ref2.targetPath, transform = _ref2.transform, failureTransform = _ref2.failureTransform, isCustomTransform = _ref2.isCustomTransform, flattenings = _ref2.flattenings, options = _ref2.options;
                            ...
                            value: function processOrItem_(sourceObject, destinationObject, _ref3) {
                                var sourcePath = _ref3.sourcePath, targetPath = _ref3.targetPath, transform = _ref3.transform, failureTransform = _ref3.failureTransform, flattenings = _ref3.flattenings, options = _ref3.options;
                                var orValue = void 0;
            ...
            }, { "./mapping": 11, "lodash.clonedeep": 1, "lodash.flattendeep": 3, "lodash.flattendepth": 4 }], 11: [function (require, module, exports) {
                "use strict";
                Object.defineProperty(exports, "__esModule", {
                    value: true
                });
                ...
                var Mapping = function () {
                    ...
                    _createClass(Mapping, [{
                            ...
                            key: "processSort_",
                            value: function processSort_(value, comparer) {
                                ...
                                if (typeof comparer === "function") {
                                    return isReverse ? (0, _lodash10.default)(valueToUse, comparer).reverse() : (0, _lodash10.default)(valueToUse, comparer);
                                }
                                return isReverse ? (0, _lodash10.default)(valueToUse).reverse() : (0, _lodash10.default)(valueToUse);
                            }
                        }, {
                            key: "sort",
                            value: function sort(comparer) {
                                ...
                                this.validateSourceForOps();
                                this.pushToPipelineTransformations_(function (source, value) {
                                    return _this5.processSort_(value, comparer);
                                });
                                return this;
                            }
                        }, {
                            key: "reverseSort",
                            value: function reverseSort(comparer) {
                                var _this6 = this;
                                this.validateSourceForOps();
                                this.pushToPipelineTransformations_(function (source, value) {
                                    return _this6.processSort_(value, comparer, true);
                                });
                                return this;
                            }
                        }, {
            ...
            }, { "lodash.clonedeep": 1, "lodash.compact": 2, "lodash.set": 5, "lodash.sortby": 6, "lodash.unset": 7 }], 12: [function (require, module, exports) {
                'use strict';
                /* eslint-disable */
                ...
                function getValue(fromObject, fromKey) {
                    var regDot = /\./g, regFinishArray = /.+(\[\])/g, keys, key, result, lastValue;
                ...
                function handleArrayOfUndefined_(value) {
                    ...
                    if (Array.isArray(value) === true) {
                        var emptyTest = flattenDeep(value);
                ...
                function scanArrayForValue_(arrayToScan, defaultValue) {
                    ...
                    var _iteratorError = undefined;
                    try {
                        for (var _iterator = arrayToScan[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                            var item = _step.value;
                ...
                function _getValue(fromObject, key, keys) {
                    var regArray = /(\[\]|\[(.*)\])$/g, match, arrayIndex, isValueArray = false, result;
                    if (!fromObject) {
                        return;
                    }
            ...
            }, { "lodash.flattendeep": 3 }], 13: [function (require, module, exports) {
                "use strict";
                var _require = require("./get-key-value"), getValue = _require.getValue;
                var setValue = require("./set-key-value");
                module.exports.getValue = getValue;
                module.exports.setValue = setValue;
            }, { "./get-key-value": 12, "./set-key-value": 14 }], 14: [function (require, module, exports) {
                "use strict";
                var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; };
                /* eslint-disable */
                /**
                ...
                function _setValue(destinationObject, startKey, keys, fromValue, depth) {
                    ...
                    var regArray = /(\[\]|\[(.*)\])$/g, regAppendArray = /(\[\]|\[(.*)\]\+)$/g, regCanBeNull = /(\?)$/g, match, appendToArray, canBeNull, arrayIndex = 0, valueIndex, isPropertyArray = false, isValueArray = false, value;
                    var key = startKey;
                    depth++;
                    ...
                    if (keys.length === 0) {
                        ...
                        if (!canBeNull && (fromValue === null || fromValue === undefined)) {
                            ...
                            if (parentIsArray === true && destinationStartedEmpty)
                                return null;
                            if (isValueArray) {
                                destinationObject[key] = [];
                            }
